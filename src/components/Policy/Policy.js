        ...
        <li className='policy__item policy__item_title'>
          ...
          <ol className='policy__list policy__list_down'>
            ...
            <li className='policy__item'>
              ...
              доступность в сети интернет по сетевому адресу https://qex.team/;
            </li>
            <li className='policy__item'>
            ...
            <li className='policy__item'>
              Пользователь – любой посетитель веб-сайта https://qex.team/;
            </li>
            <li className='policy__item'>
        ...
        <li className='policy__item policy__item_title'>
          ...
          <ol className='policy__list policy__list_down'>
            ...
            <li className='policy__item'>
              ...
              электронной почты hello@qex.team с пометкой «Отказ от
         ...
         <li className='policy__item policy__item_title'>
          ...
          <ol className='policy__list policy__list_down'>
            <li className='policy__item'>
              ...
              https://qex.team/. Заполняя соответствующие формы и/или отправляя
        ...
        <li className='policy__item policy__item_title'>
          ...
          <ol className='policy__list policy__list_down'>
            ...
            <li className='policy__item'>
              ...
              Оператора hello@qex.team с пометкой «Актуализация персональных
              данных».
            </li>
            <li className='policy__item'>
              ...
              hello@qex.team с пометкой «Отзыв согласия на обработку
              персональных данных».
            </li>
          </ol>
        </li>
        ...
        <li className='policy__item policy__item_title'>
          ...
          <ol className='policy__list policy__list_down'>
            <li className='policy__item'>
              ...
              к Оператору с помощью электронной почты hello@qex.team.
            </li>
            <li className='policy__item'>
            ...
            <li className='policy__item'>
              ...
              сети Интернет по адресу https://qex.team/policy
            </li>
          </ol>
        </li>
      </ol>
